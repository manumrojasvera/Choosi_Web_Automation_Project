...
WebUI.check(findTestObject('Page_Choosi_Login/input_ember565'))

WebUI.click(findTestObject('Page_Choosi_Login/button_Confirm'))

WebUI.click(findTestObject('Page_Choosi_Login/button_Sign In'))

WebUI.click(findTestObject('Page_Choosi_Login/a_Sign Out'))

WebUI.waitForElementPresent(findTestObject('Page_Choosi_Login/a_Switch Menus'), 30)
...
output_username = WebUI.getAttribute(findTestObject('Page_Choosi_Login/input_identification'), 'value')

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(output_username, 'Julieta', true, FailureHandling.STOP_ON_FAILURE)
