...
WebUI.setText(findTestObject('Page_Choosi_Login/input_identification'), 'luciana')

WebUI.setEncryptedText(findTestObject('Page_Choosi_Login/input_password'), 'mRRU4MDgk5NPW+ADh8IWwQ==')
